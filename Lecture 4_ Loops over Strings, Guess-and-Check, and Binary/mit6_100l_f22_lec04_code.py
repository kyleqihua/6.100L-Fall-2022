...
#         flag_absence = True 
# if flag_absence:
#     print("no secret number is found")
...
# suggested by ddb 
# total_tickets = 1000
# for A in range(0, total_tickets):
#     B = A - 20
#     C = 2 * A
#     if A + B + C == total_tickets:
#         print(A)
#         break

# from the course: mix algebra and computation
# only one loop over one variable
# and replace loop with calcuation of other two variables 
...
# text2_unique = ""
# for t1 in text1:
#     if t1 not in text1_unique:
#         text1_unique += t1
# for t2 in text2:
#     if t2 not in text2_unique:
#         text2_unique += t2
# count = 0
# for t_unique in text1_unique:
#     if t_unique in text2_unique:
#         count += 1
# print(count)
